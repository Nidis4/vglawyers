<?php
	...
	function addPublication($title_el, $title_en, $media_el, $media_en, $lawyerid){
		$connect = initDB();
		mysqli_query($connect,"INSERT INTO `PUBLICATIONS`(`TITLE_EL`, `TITLE_EN`, `MEDIA_EL`, `MEDIA_EN`, `LAWYER_ID`) VALUES ('$title_el', '$title_en', '$media_el', '$media_en',$lawyerid)");
		//echo "INSERT INTO `PUBLICATIONS`(`TITLE_EL`, `TITLE_EN`, `MEDIA_EL`, `MEDIA_EN`, `LAWYER_ID`) VALUES ('$title_el', '$title_en', '$media_el', '$media_en',$lawyerid)";

	}

	function updatePublication($id, $title_el, $title_en, $media_el, $media_en, $lawyerid){
		$connect = initDB();
		mysqli_query($connect,"UPDATE `PUBLICATIONS` SET `TITLE_EL`='$title_el',`TITLE_EN`='$title_en',`MEDIA_EL`='$media_el',`MEDIA_EN`='$media_en',`LAWYER_ID`='$lawyerid' WHERE `ID`= $id");
		//echo "INSERT INTO `PUBLICATIONS`(`TITLE_EL`, `TITLE_EN`, `MEDIA_EL`, `MEDIA_EN`, `LAWYER_ID`) VALUES ('$title_el', '$title_en', '$media_el', '$media_en',$lawyerid)";
